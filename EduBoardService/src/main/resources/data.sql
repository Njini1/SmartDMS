...
VALUES
    ...
    ('테스트문서1_주간회의', 'ACTIVE', 5, 0, NULL, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('테스트문서2_주간회의', 'ACTIVE', 2, 0, NULL, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('테스트문서3_주간회의', 'ACTIVE', 3, 0, NULL, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('테스트문서4_주간회의', 'ACTIVE', 3, 0, NULL, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
--
...
(document_id, version_number, content, content_text, content_signature, updated_by, updated_date, change_reason)
VALUES
(1, 1,
 '<h2>주간회의 회의록 (초안)</h2><ul><li>일시: 2025-12-01</li><li>참석: 사용자1, 사용자2</li></ul><h3>안건</h3><ol><li>이번 주 개발 범위 확정</li><li>문서 버전 관리 방식 논의</li></ol><h3>결정사항</h3><ul><li>문서 생성 시 v1 자동 생성</li><li>수정 시 v2, v3 ... 증가</li></ul>',
 '주간회의 회의록 (초안) 일시: 2025-12-01 참석: 사용자1, 사용자2 안건 1) 이번 주 개발 범위 확정 2) 문서 버전 관리 방식 논의 결정사항 문서 생성 시 v1 자동 생성 수정 시 v2, v3 ... 증가',
 'e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855',
--  SHA2('<h2>주간회의 회의록 (초안)</h2><ul><li>일시: 2025-12-01</li><li>참석: 사용자1, 사용자2</li></ul><h3>안건</h3><ol><li>이번 주 개발 범위 확정</li><li>문서 버전 관리 방식 논의</li></ol><h3>결정사항</h3><ul><li>문서 생성 시 v1 자동 생성</li><li>수정 시 v2, v3 ... 증가</li></ul>', 256),
 1, '2025-12-01 10:20:00', '최초 등록'),

(1, 2,
 '<h2>주간회의 회의록 (수정)</h2><ul><li>일시: 2025-12-01</li><li>참석: 사용자1, 사용자2, 사용자3</li></ul><h3>변경</h3><ul><li>참석자 사용자3 추가</li><li>결정사항에 “소프트 삭제/폐기 정책” 항목 추가</li></ul><h3>결정사항</h3><ul><li>문서 폐기는 DISPOSED 상태로 관리</li></ul>',
 '주간회의 회의록 (수정) 일시: 2025-12-01 참석: 사용자1, 사용자2, 사용자3 변경 참석자 사용자3 추가 결정사항에 소프트 삭제/폐기 정책 항목 추가 결정사항 문서 폐기는 DISPOSED 상태로 관리',
    'e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855',
    2, '2025-12-02 09:10:00', '참석자 및 결정사항 수정'),

-- document_id = 2 (기안서)
(2, 1,
 '<h3>장비 구매 요청 기안서</h3><ul><li>요청 품목: 서버 SSD 2TB x 2</li><li>사유: 로그/문서 저장 용량 부족</li><li>예상 금액: 48만원</li><li>결재 라인: 팀장 → 본부장</li></ul>',
 '장비 구매 요청 기안서 요청 품목: 서버 SSD 2TB x 2 사유: 로그/문서 저장 용량 부족 예상 금액: 48만원 결재 라인: 팀장 → 본부장', 'e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855',
2, '2025-12-03 14:00:00', '최초 등록'),

(2, 2,
 '<h3>장비 구매 요청 기안서</h3><ul><li>요청 품목: 서버 SSD 2TB x 4 (변경)</li><li>사유: 문서 버전 저장량 증가 예상</li><li>예상 금액: 96만원</li><li>참고: RAID 구성 고려</li></ul>',
 '장비 구매 요청 기안서 요청 품목: 서버 SSD 2TB x 4 (변경) 사유: 문서 버전 저장량 증가 예상 예상 금액: 96만원 참고: RAID 구성 고려',
'e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855',
2, '2025-12-04 11:30:00', '수량 변경 및 사유 보완'),

(2, 3,
 '<h3>장비 구매 요청 기안서</h3><ul><li>요청 품목: 서버 SSD 2TB x 4</li><li>사유: 문서 저장량 + 백업 정책 반영</li><li>추가: 분기별 스냅샷 백업 계획 포함</li></ul>',
 '장비 구매 요청 기안서 요청 품목: 서버 SSD 2TB x 4 사유: 문서 저장량 + 백업 정책 반영 추가: 분기별 스냅샷 백업 계획 포함',
 'e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855',
1, '2025-12-05 09:05:00', '백업 계획 추가'),

-- document_id = 3 (보안가이드)
(3, 1,
 '<h1>보안 가이드</h1><ol><li>비밀번호 정책: 12자 이상</li><li>권한 정책: 최소권한 원칙</li><li>로그 정책: 접근/변경 로그 보관</li></ol>',
 '보안 가이드 1. 비밀번호 정책: 12자 이상 2. 권한 정책: 최소권한 원칙 3. 로그 정책: 접근/변경 로그 보관',
'e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855',
3, '2025-12-01 18:10:00', '최초 등록'),

(3, 2,
 '<h1>보안 가이드</h1><ol><li>비밀번호 정책: 12자 이상 + 주기적 변경</li><li>권한 정책: 최소권한 원칙 + 역할 기반(Role)</li><li>로그 정책: 접근/변경 로그 1년 보관</li><li>데이터 마스킹: 개인정보 필드 적용</li></ol>',
 '보안 가이드 1. 비밀번호 정책: 12자 이상 + 주기적 변경 2. 권한 정책: 최소권한 원칙 + 역할 기반(Role) 3. 로그 정책: 접근/변경 로그 1년 보관 4. 데이터 마스킹: 개인정보 필드 적용',
 'e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855',
  4, '2025-12-06 16:40:00', '보관 기간 및 마스킹 항목 추가'),

-- document_id = 4 (요구사항)
(4, 1,
 '<h1>SmartDMS 요구사항</h1><ul><li>문서(Document) / 버전(DocumentVersion) 분리</li><li>현재 버전 currentVersion 참조</li><li>낙관적 락(@Version)으로 동시성 처리</li><li>문서 상태: ACTIVE / ARCHIVED / DISPOSED</li></ul>',
 'SmartDMS 요구사항 문서(Document) / 버전(DocumentVersion) 분리 현재 버전 currentVersion 참조 낙관적 락(@Version)으로 동시성 처리 문서 상태: ACTIVE / ARCHIVED / DISPOSED',
'e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855',
1, '2025-12-02 13:20:00', '최초 등록'),

(4, 2,
 '<h1>SmartDMS 요구사항</h1><ul><li>diff 기능: 버전 간 비교</li><li>변경 사유 기록(changeReason)</li><li>문서 목록 페이지: 제목/작성자/현재버전/수정일 표시</li></ul>',
 'SmartDMS 요구사항 diff 기능: 버전 간 비교 변경 사유 기록(changeReason) 문서 목록 페이지: 제목/작성자/현재버전/수정일 표시',
'e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855',
1, '2025-12-07 21:10:00', '화면 요구사항 및 diff 추가'),

-- document_id = 5 (인수인계서)
(5, 1,
 '<h2>백엔드 운영 인수인계서</h2><ul><li>배포: GitHub Actions + EC2</li><li>DB: MySQL</li><li>장애 대응: 커넥션 풀, 슬로우 쿼리 점검</li></ul>',
 '백엔드 운영 인수인계서 배포: GitHub Actions + EC2 DB: MySQL 장애 대응: 커넥션 풀, 슬로우 쿼리 점검',
'e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855',
4, '2025-11-20 09:00:00', '최초 등록'),

(5, 2,
 '<h2>백엔드 운영 인수인계서</h2><ul><li>배포: GitHub Actions + EC2</li><li>추가: 롤백 절차 문서화</li><li>추가: 모니터링 알람 기준 정리</li></ul>',
 '백엔드 운영 인수인계서 배포: GitHub Actions + EC2 추가: 롤백 절차 문서화 추가: 모니터링 알람 기준 정리',
'e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855',
4, '2025-12-01 09:00:00', '롤백/모니터링 항목 추가'),

-- document_id = 6 (폐기 문서)
(6, 1,
 '<p>이 문서는 테스트용이며 폐기 처리 예정입니다.</p><ul><li>내용: 임시 텍스트</li><li>목적: DISPOSED 상태 문서 조회 테스트</li></ul>',
 '이 문서는 테스트용이며 폐기 처리 예정입니다. 내용: 임시 텍스트 목적: DISPOSED 상태 문서 조회 테스트',
'e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855',
5, '2025-10-01 12:00:00', '최초 등록'),

(6, 2,
 '<p>이 문서는 폐기 완료되었습니다.</p><ul><li>접근 제한 확인</li><li>목록/상세 조회 정책 점검</li></ul>',
 '이 문서는 폐기 완료되었습니다. 접근 제한 확인 목록/상세 조회 정책 점검',
'e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855',
5, '2025-10-03 12:00:00', '폐기 처리 반영'),

-- document_id = 7 (회의록)
(7, 1,
 '<h2>주간회의 회의록 (2025-12-08)</h2><ul><li>안건: 성능 최적화, 인덱스 점검</li><li>결정: document_id + version_number 유니크 고려</li></ul>',
 '주간회의 회의록 (2025-12-08) 안건: 성능 최적화, 인덱스 점검 결정: document_id + version_number 유니크 고려',
'e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855',
2, '2025-12-08 10:10:00', '최초 등록'),

-- document_id = 8 (장애보고서)
(8, 1,
 '<h3>장애 보고서</h3><ul><li>현상: DB 커넥션 타임아웃 증가</li><li>원인 추정: 커넥션 풀 고갈</li><li>조치: 타임아웃/풀 설정 조정, 슬로우쿼리 확인</li></ul>',
 '장애 보고서 현상: DB 커넥션 타임아웃 증가 원인 추정: 커넥션 풀 고갈 조치: 타임아웃/풀 설정 조정, 슬로우쿼리 확인',
'e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855',
3, '2025-12-09 08:30:00', '최초 등록'),

(8, 2,
 '<h3>장애 보고서</h3><ul><li>원인 확정: N+1로 인한 쿼리 폭증</li><li>조치: fetch join 적용, 인덱스 추가</li><li>재발 방지: 모니터링 알람 기준 강화</li></ul>',
 '장애 보고서 원인 확정: N+1로 인한 쿼리 폭증 조치: fetch join 적용, 인덱스 추가 재발 방지: 모니터링 알람 기준 강화',
 'e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855',
  1, '2025-12-10 12:15:00', '원인 확정 및 조치사항 업데이트'),

-- document_id = 9~12 (테스트 문서들)
(9, 1,
 '<h2>주간회의 회의록 (초안)</h2><p>테스트 문서용 본문입니다.</p>',
 '주간회의 회의록 (초안) 테스트 문서용 본문입니다.',
'e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855',
1, '2025-12-01 10:20:00', '최초 등록'),
...
(11, 1,
 '<h2>주간회의 회의록 (초안)</h2><ul><li>일시: 2025-12-01</li><li>참석: 사용자1, 사용자2</li><li>안건: 개발 범위 확정 / 버전관리 논의</li></ul>',
 '주간회의 회의록 (초안) 일시: 2025-12-01 참석: 사용자1, 사용자2 안건: 개발 범위 확정 / 버전관리 논의',
'e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855',
1, '2025-12-01 10:20:00', '최초 등록'),

(12, 1,
 '<h2>주간회의 회의록 (초안)</h2><p>결정사항: 문서 생성 시 v1 자동 생성, 수정 시 v2, v3 ... 증가</p>',
 '주간회의 회의록 (초안) 결정사항: 문서 생성 시 v1 자동 생성, 수정 시 v2, v3 ... 증가',
'e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855',
1, '2025-12-01 10:20:00', '최초 등록');
